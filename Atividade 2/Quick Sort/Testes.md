**Melhor caso:** O array é balanceado e o pivô é centralizado, permitindo divisões iguais em cada iteração. O algoritmo teve um bom desempenho em relação ao tempo de execução.
